...
class CustomNode extends React.Component<CustomNodeProps> {
    ...
    render() {
        ...
        return <div className='customNode' style={nodeStyle}>
            ...
            top:'50%'}} id='rt'/>
            <Handle type='target' position={Position.Bottom} style={{backgroundColor:NodeHandleColor,
            left:'50%'}} id='bt'/>
            <Handle type='target' position={Position.Top} style={{backgroundColor:NodeHandleColor,
            left:'50%'}} id='tt'/>
            <Handle type='source' position={Position.Left} style={{backgroundColor:NodeHandleColor,
            top:'50%'}} id='ls'/>
            <Handle type='source' position={Position.Right} style={{backgroundColor:NodeHandleColor,
            top:'50%'}} id='rs'/>
            <Handle type='source' position={Position.Bottom} style={{backgroundColor:NodeHandleColor,
            left:'50%'}} id='bs'/>
            <Handle type='source' position={Position.Top} style={{backgroundColor:NodeHandleColor,
            left:'50%'}} id='ts'/>
        </div>
    }
}
