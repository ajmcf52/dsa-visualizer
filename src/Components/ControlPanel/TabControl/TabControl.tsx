    ...
    return (
        <div className='tabContainer'>
            <ul className='tabRow'>
                <li
                    id='sorting'
                    className={selectedTab === 'sorting' ? 'selected' : ''}
                    onClick={(e) => {
                ...
                <li
                    id='searching'
                    className={selectedTab === 'searching' ? 'selected' : ''}
                    onClick={(e) => {
                        tabClick(e.currentTarget.id)
                    }}
                >
...
const connectedComp = connect(mapStateToProps, mapDispatchToProps)(TabControl)
